...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sensAMonPortLE.setGeometry(QtCore.QRect(118, 77, 70, 18))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sensAMonPortLE.setMinimumSize(QtCore.QSize(70, 0))
        self.sensAMonPortLE.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        ...
        self.sensBMonPortLE.setGeometry(QtCore.QRect(118, 77, 70, 18))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sensBMonPortLE.setMinimumSize(QtCore.QSize(70, 0))
        self.sensBMonPortLE.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.q330GB.setGeometry(QtCore.QRect(10, 40, 310, 210))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 30, 290, 171))
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.staLE)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.tagnoLE)
        ...
        self.snLE.setMinimumSize(QtCore.QSize(135, 0))
        self.snLE.setMaximumSize(QtCore.QSize(135, 16777215))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.snLE)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.dpLE)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.dpauthLE)
        ...
        self.ipLE.setMinimumSize(QtCore.QSize(135, 0))
        self.ipLE.setMaximumSize(QtCore.QSize(135, 16777215))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.ipLE)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.calDetailsGB.setTitle(_translate("MainWindow", "Configuration Details"))
        ...
        self.sensAMonPortLE.setPlaceholderText(_translate("MainWindow", "[4-6]"))
        self.sensALastLFLE.setToolTip(_translate("MainWindow", "Timestamp of previous (successful) HIGH Frequency calibration (UTC)"))
        self.sensALastLFLE.setPlaceholderText(_translate("MainWindow", "Unknown"))
        ...
        self.sensADescrLE.setPlaceholderText(_translate("MainWindow", "Ear to the Ground Model X"))
        ...
        self.sensALastHFLE.setPlaceholderText(_translate("MainWindow", "Unknown"))
        ...
        self.sensBLastLFLE.setPlaceholderText(_translate("MainWindow", "Unknown"))
        self.sensBLastHFLE.setToolTip(_translate("MainWindow", "Timestamp of previous (successful) LOW Frequency calibration (UTC)"))
        self.sensBLastHFLE.setPlaceholderText(_translate("MainWindow", "Unknown"))
        ...
        self.sensBDescrLE.setPlaceholderText(_translate("MainWindow", "Mantle Muncher mod 1"))
        ...
        self.sensBMonPortLE.setPlaceholderText(_translate("MainWindow", "[1-3]"))
        ...
        self.label_12.setText(_translate("MainWindow", "Calib Data Port:"))

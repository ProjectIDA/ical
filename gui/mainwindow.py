...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1090, 665))
        MainWindow.setMaximumSize(QtCore.QSize(1090, 665))
        ...
        self.calDetailsGB.setGeometry(QtCore.QRect(10, 270, 1070, 311))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.sensorAGB.setGeometry(QtCore.QRect(330, 34, 360, 211))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label.setGeometry(QtCore.QRect(71, 31, 42, 16))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 78, 102, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_3.setGeometry(QtCore.QRect(11, 105, 101, 20))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sensAPriChansLE = QtWidgets.QLineEdit(self.sensorAGB)
        self.sensAPriChansLE.setGeometry(QtCore.QRect(118, 105, 230, 20))
        self.sensAPriChansLE.setMinimumSize(QtCore.QSize(230, 0))
        self.sensAPriChansLE.setMaximumSize(QtCore.QSize(230, 16777215))
        font = QtGui.QFont()
        font.setFamily("PT Mono")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.sensAPriChansLE.setFont(font)
        self.sensAPriChansLE.setFrame(False)
        self.sensAPriChansLE.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.sensAPriChansLE.setReadOnly(True)
        self.sensAPriChansLE.setPlaceholderText("")
        self.sensAPriChansLE.setObjectName("sensAPriChansLE")
        ...
        self.sensBPriChansLE = QtWidgets.QLineEdit(self.sensorBGB)
        self.sensBPriChansLE.setGeometry(QtCore.QRect(118, 105, 230, 17))
        self.sensBPriChansLE.setMinimumSize(QtCore.QSize(230, 0))
        self.sensBPriChansLE.setMaximumSize(QtCore.QSize(230, 16777215))
        font = QtGui.QFont()
        font.setFamily("PT Mono")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.sensBPriChansLE.setFont(font)
        self.sensBPriChansLE.setFrame(False)
        self.sensBPriChansLE.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.sensBPriChansLE.setReadOnly(True)
        self.sensBPriChansLE.setPlaceholderText("")
        self.sensBPriChansLE.setObjectName("sensBPriChansLE")
        ...
        self.label_10.setGeometry(QtCore.QRect(71, 31, 42, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_14.setGeometry(QtCore.QRect(10, 78, 102, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_4 = QtWidgets.QLabel(self.sensorBGB)
        self.label_4.setGeometry(QtCore.QRect(12, 103, 101, 20))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(5, 17, 295, 191))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 250, 1051, 51))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.q330Info = QtWidgets.QLabel(self.groupBox)
        self.q330Info.setGeometry(QtCore.QRect(10, 5, 1031, 41))
        font = QtGui.QFont()
        ...
        self.q330Info.setWordWrap(True)
        ...
        icon = QtGui.QIcon.fromTheme("Q")
        self.actionQuit.setIcon(icon)
        self.actionQuit.setObjectName("actionQuit")
        self.actionAbout_PyCal = QtWidgets.QAction(MainWindow)
        self.actionAbout_PyCal.setEnabled(True)
        self.actionAbout_PyCal.setObjectName("actionAbout_PyCal")
        self.acViewLogMessages = QtWidgets.QAction(MainWindow)
        self.acViewLogMessages.setObjectName("acViewLogMessages")
        self.actionUOSS_2016 = QtWidgets.QAction(MainWindow)
        self.actionUOSS_2016.setCheckable(True)
        self.actionUOSS_2016.setObjectName("actionUOSS_2016")
        self.actionAAK_2015 = QtWidgets.QAction(MainWindow)
        self.actionAAK_2015.setCheckable(True)
        self.actionAAK_2015.setVisible(True)
        self.actionAAK_2015.setObjectName("actionAAK_2015")
        self.actionXPFO_2016 = QtWidgets.QAction(MainWindow)
        self.actionXPFO_2016.setCheckable(True)
        self.actionXPFO_2016.setObjectName("actionXPFO_2016")
        self.actionRPN = QtWidgets.QAction(MainWindow)
        self.actionRPN.setCheckable(True)
        self.actionRPN.setObjectName("actionRPN")
        self.actionTAU = QtWidgets.QAction(MainWindow)
        self.actionTAU.setCheckable(True)
        self.actionTAU.setObjectName("actionTAU")
        self.actionBORG = QtWidgets.QAction(MainWindow)
        self.actionBORG.setCheckable(True)
        self.actionBORG.setObjectName("actionBORG")
        self.actionPFO_CTBTO = QtWidgets.QAction(MainWindow)
        self.actionPFO_CTBTO.setCheckable(True)
        self.actionPFO_CTBTO.setObjectName("actionPFO_CTBTO")
        self.actionERM = QtWidgets.QAction(MainWindow)
        self.actionERM.setCheckable(True)
        self.actionERM.setObjectName("actionERM")
        self.actionALE = QtWidgets.QAction(MainWindow)
        self.actionALE.setCheckable(True)
        self.actionALE.setObjectName("actionALE")
        self.actionVerbose_Log = QtWidgets.QAction(MainWindow)
        self.actionVerbose_Log.setCheckable(True)
        self.actionVerbose_Log.setObjectName("actionVerbose_Log")
        ...
        self.menuFile.addAction(self.actionAbout_PyCal)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addBtn.setText(_translate("MainWindow", "New..."))
        ...
        self.label_3.setText(_translate("MainWindow", "Pri Chan Codes:"))
        self.sensAMonPortLE.setToolTip(_translate("MainWindow", "<html><head/><body><p>Calibration Monitoring Port.</p></body></html>"))
        self.sensAPriChansLE.setToolTip(_translate("MainWindow", "Timestamp of previous (successful) HIGH Frequency calibration (UTC)"))
        ...
        self.sensBPriChansLE.setToolTip(_translate("MainWindow", "Timestamp of previous (successful) HIGH Frequency calibration (UTC)"))
        ...
        self.label_4.setToolTip(_translate("MainWindow", "Timestamp of previous (successful) HIGH Frequency calibration (UTC)"))
        ...
        self.actionAbout_PyCal.setText(_translate("MainWindow", "About PyCal..."))
        self.actionAbout_PyCal.setToolTip(_translate("MainWindow", "About PyCal"))
        ...
        self.acViewLogMessages.setShortcut(_translate("MainWindow", "Ctrl+L"))
        self.actionUOSS_2016.setText(_translate("MainWindow", "UOSS"))
        self.actionAAK_2015.setText(_translate("MainWindow", "AAK"))
        self.actionXPFO_2016.setText(_translate("MainWindow", "XPFO"))
        self.actionRPN.setText(_translate("MainWindow", "RPN"))
        self.actionTAU.setText(_translate("MainWindow", "TAU"))
        self.actionBORG.setText(_translate("MainWindow", "BORG"))
        self.actionPFO_CTBTO.setText(_translate("MainWindow", "PFO-CTBTO"))
        self.actionERM.setText(_translate("MainWindow", "ERM"))
        self.actionALE.setText(_translate("MainWindow", "ALE"))
        self.actionVerbose_Log.setText(_translate("MainWindow", "Verbose Log"))

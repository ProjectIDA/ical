...
# this enables fix of problems with Qt5.5.x wherre plugins dylibs 
# don't have any @rpath defined internally
extra_paths = ['']
    ...
    for header in m.headers:
        for command in header.commands:
            ...
            if cmd_type == LC_RPATH:
                # rpath = str(command[2])
                # this fixes problems for for Python 3+ users
                ...
                # this fixes problems with @loader_path being munged by os.path.normpath
